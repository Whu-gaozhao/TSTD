_base_ = [
    '../_base_/datasets/scannet_seg-3d_23dim_block.py',
    '../_base_/models/mve_pct.py', '../_base_/schedules/seg_cosine_100e.py',
...
model = dict(
    backbone=dict(
        in_channels=23,
        sa_cfg=dict(use_xyz=False),
        fu_cfg=dict(type='AddFusionModule')),
        # fu_cfg=dict(
        #     type='SA_Layer', normal_type='SS', offset=False, slice=True)),
    decode_head=dict(
