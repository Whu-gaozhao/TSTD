...
data_root = '/home/zhao/DataSets/scannet/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'segformer-b4-256/scannet_infos_train.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'segformer-b4-256/scannet_infos_val.pkl',
