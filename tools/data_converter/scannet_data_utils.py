...
class ScanNetData(object):
    ...
    def get_infos(self, num_workers=4, has_label=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            mmcv.mkdir_or_exist(osp.join(self.root_dir, 'segformer_b0_points'))
            points.tofile(
                osp.join(self.root_dir, 'segformer_b0_points', f'{sample_idx}.bin'))
            info['pts_path'] = osp.join('segformer_b0_points', f'{sample_idx}.bin')
